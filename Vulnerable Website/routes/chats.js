...
router.get('/room/:id', Auth, async (req, res) => {
    if (req.params.id == "new") {
        res.render('chat', { title: 'CrackJack - Chat', user: req.user });
    }
    else {
        ...
        res.render('chat', { title: 'CrackJack - Chat', user: req.user, chatRoom: chatRoom, recentChats: recentChats, prevChats: html });
    }
})
